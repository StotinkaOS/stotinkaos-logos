...
# stotinkaos logos is actually centos-logos
%define real_name centos-logos
...
License: Copyright © 2014 The StotinkaOS.  All rights reserved.

BuildArch: noarch
Obsoletes: gnome-logos
Obsoletes: fedora-logos <= 16.0.2-2
Obsoletes: redhat-logos centos-logos
...
The Package and StotinkaOS logos (the "Marks") can only used as outlined
in the included COPYING file. Please see that file for information on
copying and redistribution of the StotinkaOS Marks.
...
install -p -m 644 backgrounds/default.xml $RPM_BUILD_ROOT%{_datadir}/gnome-background-properties/
...
ln -s system-logo-white.png fedora-gdm-logo.png
popd
...
* Tue Mar 31 2015 Jim Perrin <jperrin@centos.org> - 70.0.6-2
- Add symlink to fix gdm icon
