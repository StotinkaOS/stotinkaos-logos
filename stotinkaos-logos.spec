...
# stotinkaos logos is actually redhat-logos
%define real_name redhat-logos
...
The Package and StotinkaOS logos (the "Marks") can only used as outlined in
the included COPYING file. Please see that file for information on copying
and redistribution of the StotinkaOS Marks.
